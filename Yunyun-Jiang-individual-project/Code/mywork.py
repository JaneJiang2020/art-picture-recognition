...
############### create a function for plot confusion matrix ##############
...
plt.figure()
plot_confusion_matrix(cnf_matrix, classes=class_names, title='CNN: Confusion matrix')
plt.savefig('/home/ubuntu/Deep-Learning/Pytorch_/Final Project/models/plots/CNN_confusion_matrix.png')
plt.show()


#########################################################
############## Below is the pretrained VGG model ########
#########################################################
